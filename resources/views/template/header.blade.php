...
<body>
    ...
    <i class="bi bi-phone-vibrate fs-1 me-2" style="color: blue;"></i>
    <h2 class="mb-0" >+216 23 828 177</h2>
</div>
    ...
    <div class="d-flex align-items-center justify-content-center">
        <a href="{{('home')}}" class="navbar-brand ms-lg-5 custom-logo">
            <h1 class="m-0 display-4 text-primary">
                 <img src="{{ asset('img/logo_Gines_Group.jpg') }}"alt="Logo De Gines Group" style="width: 100px; height: auto;">
            </h1>
        </a>
    </div>
</div>
            <div class="col-lg-3">
                <div class="d-flex align-items-center justify-content-end">
                    <a class="btn btn-primary btn-square rounded-circle me-2" href="https://www.facebook.com/ginesgroup1?locale=fr_FR"style="background-color: blue; border-color: blue;"><i class="fab fa-facebook-f"></i></a>
                    <a class="btn btn-primary btn-square rounded-circle me-2" href="https://www.instagram.com/ginesgroup1/?igsh=Z2p4M29ldTdkbXd6"
  ...
  <i class="fab fa-instagram"></i>
    ...
    <style>
        ...
        .navbar {
        background-color: #0000FF; /* Couleur bleue pour la navbar */
        padding: 15px;
        display: flex;
        ...
        .search-bar button {
        padding: 10px;
        background-color: blue; /* Couleur de fond pour le bouton de recherche */
        color: white;
        border: none;
        border-radius: 5px;
        cursor: pointer;
...
nav {
    background-color: blue; /* Couleur bleue primaire */
    padding: 10px;
    color: white;
    display: flex;
    justify-content: space-between;
...
nav a:hover {
    color: lightgray; /* Couleur pour le survol des liens */
}
...
.profile-options {
    ...
    top: 100%;
    right: 0;
    background-color: blue; /* Couleur bleue au lieu de vert */
...
.custom-list li:not(:last-child):after {
    ...
    background-color: blue; /* Couleur de la ligne au lieu de noire */
}
