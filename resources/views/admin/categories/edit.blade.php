...
<head>
    ...
    <title>Gines Group Admin Dashboard</title>
    ...
    <div class="row">
        ...
        <a href="{{('home')}}" class="navbar-brand ms-lg-5 custom-logo">
            <h1 class="m-0 display-4 text-primary">
                 <img src="../img/logo_Gines_Group.jpg" alt="Logo " style="width: 500px; height: auto;">
            </h1><br><br>
        </a>
    </div>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2" style="color: blue;">Tableau de bord</h1>
            </div>
