    ...
    <div class="col-sm-6">
        <div class="card ml-8"><br>
            ...
            <div class="col-md-6">
                    ...
                    <img src="img/regist.jpg" alt="Votre photo" class="img-fluid" style="height: 420px; width: 450px;">
                </div>
                <div class="col-md-6"><br><br>
                    ...
                    <form action="{{ route ('register') }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control" id="name" placeholder="Saisir votre nom ici" required>
                        </div>
