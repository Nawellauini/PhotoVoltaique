        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <img class="w-100" src="{{ asset('img/ima.jpg') }}" alt="Image du carousel">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="{{ asset('img/panneau2.jpg') }}" alt="Image">
                    <div class="carousel-caption top-0 bottom-0 start-0 end-0 d-flex flex-column align-items-center justify-content-center">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="{{ asset('img/panneaux.jpg') }}" alt="Image">
                    <div class="carousel-caption top-0 bottom-0 start-0 end-0 d-flex flex-column align-items-center justify-content-center">
                        <div class="text-start p-5" style="max-width: 900px;">
                ...
                <div class="carousel-item">
                    <img class="w-100" src="{{ asset('img/panneaux4.jpg') }}" alt="Image">
                    <div class="carousel-caption top-0 bottom-0 start-0 end-0 d-flex flex-column align-items-center justify-content-center">
                        <div class="text-start p-5" style="max-width: 900px;">
...
<div class="col-md-3">
    <a href="/products/{{$category->id}}" class="category-link">
        <div class="category-card custom-card bg-success text-white p-7">
            <img src="{{ asset('img/categoires.jpg') }}" alt="Santé">
