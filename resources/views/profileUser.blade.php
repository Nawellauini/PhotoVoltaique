...
<div class="container">
  <div class="left">
  <form action="{{ url('/update-profile') }}" method="post" name="">
    @csrf
    <div class="header">
    <h2 class="animation a1" style="color: blue;">Salut ! De retour parmi nous</h2>
    ...
    <button type="submit" class="animation a6 btn-blue">
    <i class="far fa-save me-2" style="color :blue"></i> Enregistrer
</button>
    </div>
  </div>
  <div class="right">
